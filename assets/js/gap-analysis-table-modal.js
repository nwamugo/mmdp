  ...
  $('.gap-analysis-details').click(async function() {
    ...
    function showFocusArea(lga, innerOutput) {
      ...
      return innerOutput;
        ...
        let output = '';
        if (rowGapAnalysisArray.length === 1) {
          let innerOutput = '';
          const {
            id,
            beneficiaryCount,
            ...
            focusAreaCount,
            focusArea
          } = rowGapAnalysisArray[0]
          output += `
            <div class="lga-grid-box single-lga-grid-box">
            <div class="lga-header">
              <div class="lga-name">
                <p>${id}</p>
              </div>
              <div class="lga-stats">
                <p>Total number of beneficiaries: ${beneficiaryCount}</p>
                <p>Total number of stakeholders: ${stakeholderCount}</p>
                <p>Total number of returnees: ${returneeCount}</p>
              </div>
            </div>
            <div class="lga-body">
              ...
              <div class="lga-body-bottom">
                ...
                <ul>
                ${showFocusArea(focusArea, innerOutput)}
                </ul>
              </div>
            </div>
          </div>
